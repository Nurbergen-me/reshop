<template>
  <section class="contacts">
    <div class="container">
        ...
        Наш магазин в <span>Уфе</span>
        <a href="#" class="change-city">изменить</a>
        </h1>
        ...
        <div class="contacts__info">
            <a href="tel:8 (987) 654-23-10" class="contacts__phone"
            >8 (987) 654-23-10</a
            >
            ...
            <a href="#" class="contacts__social-icon contacts__telegram"
                ><svg
                width="32"
                height="32"
                viewBox="0 0 32 32"
            ...
            <a href="#" class="contacts__social-icon contacts__whatsapp"
                ><svg
                width="32"
                height="32"
                viewBox="0 0 32 32"
